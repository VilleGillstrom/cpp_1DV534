...
//
//
//	if (!cash.registerItem( 3,"Två Sun", 18.00 ))
//		cout << ERROR << endl;
//
//
////	return 0;
...
//		cout << ERROR << endl;
//	if (!cash.registerItem( 1,"Mjök mellan 1 lit", 6.50 ))
//		cout << ERROR << endl;
//	if (!cash.registerItem( 2,"Skottkärran Emil",  389.50 ))
//		cout << ERROR << endl;
//	if (!cash.registerItem( 2,"Råsan Gunda", 110.00 ))
//		cout << ERROR << endl;
//	if (!cash.registerItem( 1,"Socker bit i kg", 14.50 ))
//		cout << ERROR << endl;
//	if (!cash.registerItem( 3,"Tandkräm Linn",  9.50 ))
//		cout << ERROR << endl;
...
//		cout << ERROR << endl;
//	if (!cash.registerItem( 1,"Kaffe Gevalia Mk",  29.50 ))
//		cout << ERROR << endl;
...
//		cout << ERROR << endl;
//	if (!cash.registerItem( 1,"Makrillfil馥r ｽ kg",  38.50 ))
//		cout << ERROR << endl;
//	if (!cash.registerItem( 6,"Golvlampan Hilda", 230.00 ))
//		cout << ERROR << endl;
//	if (!cash.registerItem( 0,"ﾖl Pripps Bl・6-pack", 30.50 ))
//		cout << ERROR << endl;
//	if (!cash.registerItem( 6,"Rakapparaten Orvar",  99.50 ))
//		cout << ERROR << endl;
//	if (!cash.registerItem( 1,"Findus Ktf舐ss蚶 2,5 dl.", 16.00 ))
//		cout << ERROR << endl;
//	if (!cash.registerItem( 0,"Skruv 4x22 1000 st.", 80.50 ))
//		cout << ERROR << endl;
//	if (!cash.registerItem(-1,"Bl・Castello  100 gr.",  19.50 ))
